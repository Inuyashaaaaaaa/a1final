...
<body>
	...
	<form action="core/handleForms.php?id=<?php echo $_GET['id']; ?>" method="POST">
		...
		<p>
			...
			<input type="text" name="address" value="<?php echo $getUserByID['position']; ?>">
		</p>
		<p>
			<label for="firstName">Years of Experience</label> 
			<input type="text" name="state" value="<?php echo $getUserByID['years_of_experience']; ?>">
		</p>
		<p>
			<label for="firstName">Date Added</label> 
			<input type="text" name="nationality" value="<?php echo $getUserByID['date_added']; ?>">
		</p>
		<p>
